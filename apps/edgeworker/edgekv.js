...
Original Repository: https://github.com/akamai/edgeworkers-examples/tree/master/edgekv/lib
*/
...
export class EdgeKV {
	 ...
	 * 		Group must be 128 characters or less, consisting of A-Z a-z 0-9 _ or -
	 */
	constructor(namespace = "default", group = "default", edgekv_access_tokens = {}) {
		if (typeof namespace === "object") {
			this.#namespace = namespace.namespace || "default";
			this.#group = namespace.group || "default";
			this.#edgekv_access_tokens = namespace.edgekv_access_tokens || {};
			...
			this.#group = group;
			this.#edgekv_access_tokens = edgekv_access_tokens;
